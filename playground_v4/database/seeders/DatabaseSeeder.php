    ...
    public function run()
    {
        ...
        foreach (range(1,4) as $user_id) {
            DB::table('users')->insert([
                ...
                "password"=>Hash::make("hellobyte$admin_id!"),
                "created_at"=>now()
            ]);
        }
        ...
        foreach (range(1,4) as $user_id) {
            DB::table('games')->insert([
                "title"=>"Demo Game $user_id",
                "description"=>"This is demo game $user_id",
                "slug"=>Str::slug("Demo Game $user_id"),
        ...
        foreach (range(1,4) as $user_id) {
            DB::table('users')->insert([
                ...
                "password"=>Hash::make("helloworld$admin_id!"),
                "created_at"=>now()
            ]);
        }
        // create scores
