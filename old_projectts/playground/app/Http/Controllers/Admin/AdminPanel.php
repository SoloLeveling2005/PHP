...
class AdminPanel extends Controller
{
    ...
    public function __construct()
    {
        ...
        if (Auth::guard('admin')->user()) $this->admin_info = Auth::guard('admin')->user()->getAttributes()['username'];
    }
    ...
    public function game(Request $request, $slug) {
        ...
        $info = [
            ...
            "author" => (User::where('id', $info['author_id'])->first()),
            "versions" => (GameVersion::all()->where('game_id', $info['id'])),
            "deleted_at" => null,
            "created_at" => "2023-03-02 11:21:39",
            "updated_at" => "2023-03-02 11:21:39"
        ];
        //        dd($info);
