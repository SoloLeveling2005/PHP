...
<div class="bg-black p-2 mb-2">
    <ul class="nav nav-tabs border-0 container" id="myTab" role="tablist">
        ...
        <li class="nav-item d-flex align-middle" role="presentation">
            <button class="text-white bg-black fw-bold opacity-50 active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane" type="button" role="tab" aria-controls="home-tab-pane" aria-selected="true">Home</button>
        </li>
        <li class="nav-item d-flex align-middle" role="presentation">
            <button class="text-white bg-black fw-bold opacity-50" id="profile-tab" data-bs-toggle="tab" data-bs-target="#admin-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Admins</button>
        </li>
        <li class="nav-item d-flex align-middle" role="presentation">
...
<div class="tab-content" id="myTabContent">
    ...
    <div class="tab-pane fade w-100 h-100 container" id="admin-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
         <div class="mb-5">
                <p class="m-0 py-2 fs-4">Admins</p>
                <div class="row border-top border-1 border-opacity-25 border-bottom border-dark">
                    <div class="col text-black bg-grey-my fw-bold">Username</div>
