...
class AdminPanel extends Controller
{
    ...
    public $reasons, $user, $me, $games, $users, $admins, $game;
    ...
    public function __construct(Request $request) {
        ...
        $this->user = User::firstWhere('id', $request->get('user_id'));
        $this->game = Game::firstWhere('id', $request->get('game_id'));
    }
    ...
    public function user (Request $request, $username) {
        ...
        $scores = Score::with('game_version')->where('user_id',$user->id)->get();
    ...
    public function reset_all_user_score (Request $request) {
        Score::where(['user_id'=>$this->user->id])->delete();
    ...
    public function reset_all_game_score (Request $request) {
        $game_versions = Game::with('versions')->find(['id'=>$this->game->id])->first()->versions;
